...
log4j.appender.DRFA.DatePattern='.'yyyy-MM-dd'.log'
log4j.appender.DRFA.File=spark_log_
log4j.appender.DRFA.Append=true
log4j.appender.DRFA.Threshold=INFO
log4j.appender.DRFA.layout=org.apache.log4j.PatternLayout
log4j.appender.DRFA.layout.ConversionPattern=%d{yy/MM/dd HH:mm:ss} %p %t %c{1}: %m%n
