...
private[thriftserver] trait ThriftServerListener extends SparkListener {

  protected val conf: SparkConf = null
  ...
  protected val retainedStatements = conf.get(SQLConf.THRIFTSERVER_UI_STATEMENT_LIMIT)
  protected val retainedSessions = conf.get(SQLConf.THRIFTSERVER_UI_SESSION_LIMIT)
